        ...
        <div class="modal-card-body">
            ...
            <div class="row">
                ...
                <div class="input-field s12 m6 col">
                    ...
                    <input name="birth_date" placeholder="Date of Birth" class="date" type="text" data-format="Y-m-d"
            ...
            <div class="row">
                ...
                <div class="input-field s6 col">
                    ...
                    <input name="hired_date" placeholder="Hired date" class="date" type="text" data-format="Y-m-d"
                           data-large-default="true" data-theme="my-style" data-large-mode="true"
                           data-translate-mode="true" data-min-year="2018" data-max-year="2030"/>
                </div>
            </div>
        </div>
